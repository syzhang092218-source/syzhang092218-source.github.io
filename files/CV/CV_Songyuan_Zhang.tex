...
\begin{document}
	...
	\begin{rSection}{Publications}
		...
		{	
			\item {\bf [ICRA'26]}
			\paperItem{\person{Akila Saravanan}{A. Saravanan}, \person{Travis Manderson}{T. Manderson}, \person{\me}{\meshort}, \person{Nicholas Roy}{N. Roy}, and \person{Chuchu Fan}{C. Fan}}{Beyond Waypoints: Semantic-Centric Autonomy with Unreliable Maps Through Learned Abstractions}{IEEE International Conference on Robotics and Automation (ICRA)}{2026}
			\item {\bf [ICLR'26]}
	...
	\begin{rSection}{ACADEMIC SERVICES}
		...
		\item \textbf{Conference Reviewer:} \\NeurIPS, ICLR, ICML, RSS, CoRL, ICRA, L4DC, IROS, AAAI, AISTATS, CDC, ACC, NeuS, NFM, DARS, RV, TACAS
