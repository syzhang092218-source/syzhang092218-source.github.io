...
\begin{document}
	...
	\begin{rSection}{Publications}
		...
		{	
			\item {\bf [ICLR'26]}
			\paperItem{\person{\me}{\meshort}, \person{Oswin So}{O. So}, \person{H. M. Sabbir Ahmad}{H. M. Ahmad}, \person{Eric Yang Yu}{E. Y. Yu}, \person{Matthew Cleaveland}{M. Cleaveland}, \person{Mitchell Black}{M. Black}, and \person{Chuchu Fan}{C. Fan}}{ReFORM: Reflected Flows for On-support Offline RL via Noise Manipulation}{International Conference on Learning Representations (ICLR)}{2026}
			\item {\bf [ICLR'26]}
